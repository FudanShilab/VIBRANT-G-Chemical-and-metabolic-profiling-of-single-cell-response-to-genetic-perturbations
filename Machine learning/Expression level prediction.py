...
Authors:
  Minqian Wei, Minjie Fu, Tongqi Wang, Yuchen Sun, Mingyu Wang, Dan Ye, Wei Hua, Lixue Shi*

Contact:
  mqwei23@m.fudan.edu.cn
...
Usage:
  - Input: one CSV with a 'group' column (WT/KD1/KD2) and feature columns.
  - Output: console summary + optional CSV file (summary.csv).
...
CSV_PATH      = "/path/to/your/data.csv"    # <-- change to your file path
GROUP_COLNAME = "group"
